...
export default class EditUser extends Component{
    ...
    componentDidMount(){
        axios.get('http://localhost:8000/recipes/'+this.props.match.params.id)
            .then(response => {
                this.setState({
    ...
    validate = () => {
        ...
        if(this.state.name.length < 3){
            isError = true;
            errors.nameError = "First Name must be at least 3 characters";
        }
    ...
    onSubmit(e){
        ...
        axios.put('http://localhost:8000/recipes/update/'+this.props.match.params.id, obj)
